...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="/">
        <xsl:variable name="soubor">
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'A ')">
                <xsl:value-of select="concat('A/', translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
            </xsl:if>
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'BA')">
                <xsl:value-of select="concat('BA/', translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
            </xsl:if>
            
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'BASk')">
                <xsl:value-of select="concat('BA/BASk/', translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
            </xsl:if>
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'BKB-RKP')">
                <xsl:value-of select="concat('BKB-RKP/', //msDesc/msIdentifier/idno, '.html')"/>
            </xsl:if>
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'D ')">
                <xsl:value-of select="concat('D/', //msDesc/msIdentifier/idno, '.html')"/>
            </xsl:if>
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'CH')">
                <xsl:value-of select="concat('CH/', //msDesc/msIdentifier/idno, '.html')"/>
            </xsl:if>
            <xsl:if test="contains(//msDesc/msIdentifier/idno, 'Ks') or
