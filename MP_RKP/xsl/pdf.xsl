...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="page">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <xsl:apply-templates
                        select="document('file:///Z:\rukopisy\XML\Premek\RKP\RKP-0895.606.tei.xml')//msDesc"
                    />
                </fo:flow>
            </fo:page-sequence>
        </fo:root>
    ...
    <xsl:template match="msDesc">
        ...
        <fo:block font-family="TimesNewRoman" font-size="10" line-height="1" text-align="justify">
        ...
        <xsl:if test="msContents/msItem[//*/text()]">
            <xsl:choose>
                <xsl:when test="msIdentifier/idno = 'MP-RKP-0000.002'">
                    <xsl:apply-templates select="msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.003.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.004.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.005.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.006.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.007.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.008.tei.xml')//msDesc/msContents/msItem"/>
                </xsl:when>
                <xsl:when test="msIdentifier/idno = 'MP-RKP-0000.026'">
                    <xsl:apply-templates select="msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.027.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.028.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.029.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.030.tei.xml')//msDesc/msContents/msItem"/>
                    <xsl:apply-templates
                        select="document('MP-RKP-0000.031.tei.xml')//msDesc/msContents/msItem"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:apply-templates select="msContents/msItem"/>
                </xsl:otherwise>
            ...
            <fo:table space-after="10pt" space-before="10pt">
                ...
                <fo:table-body font-family="TimesNewRoman" font-size="12pt" line-height="1"
                    ...
                    <fo:table-row border-width="70pt">
                        ...
                        <fo:table-cell font-family="TimesNewRoman" font-size="10pt"
                            line-height="1" text-align="justify" space-after="10pt"
                            space-before="10pt">
                            <fo:block>
                                <xsl:apply-templates
        ...
        <xsl:if test="msContents/summary">
            <fo:block font-family="TimesNewRoman" font-size="10pt" line-height="1"
                ...
                <xsl:choose>
                    <xsl:when test="msIdentifier/idno = 'MP-RKP-0000.002'">
                        <xsl:apply-templates select="msContents/summary/note/p[1]"/>
                        <xsl:apply-templates select="msContents/msItem/note"/>
                    </xsl:when>
                    <xsl:when test="msIdentifier/idno = 'MP-RKP-0000.014'">
                        <xsl:apply-templates select="msContents/summary/note/p[1]"/>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <xsl:template match="msIdentifier">
        <fo:block font-family="TimesNewRoman" font-weight="bold" font-size="12pt" line-height="1"
            ...
            <fo:inline>
                <xsl:choose>
                    ...
                    <xsl:when test="idno = 'MP-RKP-0000.014'">
                        <xsl:text>14.-18.</xsl:text>
                    </xsl:when>
                    <xsl:when test="idno = 'MP-RKP-0000.026'">
                        <xsl:text>26.-31.</xsl:text>
                    </xsl:when>
                    <xsl:when test="idno = 'RKP-0895.606'">
            ...
            <fo:inline>
                <xsl:choose>
                    <xsl:when test="idno = 'MP-RKP-0000.002'">
                        <xsl:text>MP 2-8</xsl:text>
                    </xsl:when>
                    <xsl:when test="idno = 'MP-RKP-0000.014'">
                        <xsl:text>MP 14-18</xsl:text>
                    </xsl:when>
                    <xsl:when test="idno = 'MP-RKP-0000.026'">
                        <xsl:text>MP 26-31</xsl:text>
                    </xsl:when>
                    <xsl:when test="idno = 'RKP-0895.606'">
        ...
        <fo:block font-family="TimesNewRoman" font-size="12pt" line-height="1" color="black"
            text-align="left" page-break-after="avoid" space-after="20pt">
            <fo:inline>
                <xsl:choose>
                    <xsl:when test="idno = 'MP-RKP-0000.014'">
   ...
   -->
        ...
        <xsl:choose>
                ...
                <xsl:choose>
                    <xsl:when
                        ...
                        <xsl:if test="following-sibling::author">
                            <xsl:apply-templates select="following-sibling::author"/>
                            <xsl:text>: </xsl:text>
                        </xsl:if>
                        <xsl:text>"</xsl:text>
                        <xsl:apply-templates select="child::node()"/>
            ...
            <xsl:otherwise>
                <xsl:if test="preceding-sibling::persName[@type='author']">
                    <xsl:apply-templates select="preceding-sibling::persName[@type='author']"/>
                    <xsl:text>: </xsl:text>
                </xsl:if>
                <xsl:text>"</xsl:text>
                <xsl:apply-templates select="child::node()"/>
    ...
    <xsl:template match="physDesc">
        ...
        <xsl:if test="bindingDesc">
            <xsl:choose>
                <xsl:when test="bindingDesc/preceding-sibling::objectDesc/supportDesc/foliation">
        ...
        <xsl:if test="//msDesc/history/provenance">
            <fo:inline font-style="italic">— Historie kodexu: </fo:inline>
