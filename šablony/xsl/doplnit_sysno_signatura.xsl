...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <xsl:when test="tei:idno[@type='sysno']">
                <publicationStmt xmlns="http://www.tei-c.org/ns/1.0">
                    ...
                    <xsl:element name="idno">
                        ...
                        <xsl:value-of
                            select="document('seznam_sysna_RKP.xml')//signatura[. = $signatura]"/>
                    </xsl:element>
                    <xsl:choose>
                        <xsl:when
            ...
            <xsl:otherwise>
                <publicationStmt xmlns="http://www.tei-c.org/ns/1.0">
                    ...
                    <xsl:element name="idno">
                        ...
                        <xsl:value-of
                            select="document('seznam_sysna_RKP.xml')//sysno[following-sibling::signatura = $signatura]"
                        />
    ...
    <xsl:template match="tei:revisionDesc">
        <xsl:copy copy-namespaces="no">
            <xsl:apply-templates select="node()|@*"/>
            <change xmlns="http://www.tei-c.org/ns/1.0" when="2012-02-17">
