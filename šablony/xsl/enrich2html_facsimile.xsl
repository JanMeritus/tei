        ...
        <div CLASS="msContents">
            ...
            <xsl:if test="msItem">
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:apply-templates select="msItem[not(msItem)]"/>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:if>
        </div>
            ...
            <table border="1">
                <tr>
                    <xsl:for-each select="surface">
                        <xsl:variable name="gallery" select="graphic/@url[contains(., 'gallery')]"/>
                        <xsl:variable name="excellent"
                            select="graphic/@url[contains(., 'excellent')]"/>
                        <td>
                            <div class="img">
                                <a href="{concat($base_url, $excellent)}" target="image">
            ...
            <table border="1">
                <tr>
                    <xsl:for-each select="surface">
                        ...
                        <td>
                            <a href="{concat($base_url, $excellent, '.jp2')}" target="image">
                                <xsl:value-of select="desc/label"/>
                            </a>
                        </td>
                    </xsl:for-each>
