...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="/">
        <xsl:variable name="soubor">
            
            <xsl:value-of select="concat(translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
            <!--<xsl:choose>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'A ')">
                    <xsl:value-of select="concat('A/', translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'BA')">
                    <xsl:value-of select="concat('BA/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'BASk')">
                    <xsl:value-of select="concat('BA/BASk/', translate(//msDesc/msIdentifier/idno, '/', '_'), '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'BKB-RKP')">
                    <xsl:value-of select="concat('BKB-RKP/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'D ')">
                    <xsl:value-of select="concat('D/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'CH')">
                    <xsl:value-of select="concat('CH/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'Ks') or
                    contains(//msDesc/msIdentifier/idno, 'G') or contains(//msDesc/msIdentifier/idno,
                    'STP')">
                    <xsl:value-of select="concat('Ks/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'Mk-0000')">
                    <xsl:value-of select="concat('Mk/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'Moll-RKP')">
                    <xsl:value-of select="concat('Moll/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'MP-RKP') or
                    contains(//msDesc/msIdentifier/idno, 'MP')">
                    <xsl:value-of select="concat('MP/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'PT')">
                    <xsl:value-of select="concat('PT/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'RKP-')">
                    <xsl:value-of select="concat('RKP/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'RKP2-')">
                    <xsl:value-of select="concat('RKP2/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'RKPMus')">
                    <xsl:value-of select="concat('RKPMus/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'ST')">
                    <xsl:value-of select="concat('ST/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'STMus')">
                    <xsl:value-of select="concat('STMus/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, 'ZK')">
                    <xsl:value-of select="concat('ZK/', //msDesc/msIdentifier/idno, '.html')"/>
                </xsl:when>
            </xsl:choose>
            -->
            
        </xsl:variable>
        <xsl:variable name="lokace">
            <xsl:choose>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, ' ')">
                    <xsl:value-of select="substring-before(//msDesc/msIdentifier/idno,
                        ' ')"/>
                </xsl:when>
                <xsl:when test="contains(//msDesc/msIdentifier/idno, '-')">
                    <xsl:value-of select="substring-before(//msDesc/msIdentifier/idno,
        ...
        <xsl:result-document href="{concat($lokace, '/', $soubor)}">
            <html>
                <head>
                ...
                <body bgcolor="white">
                    ...
                    <xsl:choose>
                    <xsl:when test="//msDesc/msIdentifier/altIdentifier/idno[@type='k4_pid']">
                        <div CLASS="msDesc">
                            <b>
                                <a href="{concat('http://kramerius4.mzk.cz/search/handle/', //msDesc/msIdentifier/altIdentifier/idno[@type='k4_pid'])}" target="_blank">Digitální kopie
                                    dokumentu (Kramerius 4)</a>
                            </b>
                        </div>
                    </xsl:when>
                    <xsl:otherwise>
                    <xsl:if test="//facsimile/surface/graphic/@url">
                        <div CLASS="msDesc">
                            <b>
                                <a href="{//facsimile/@xml:base}" target="_blank">Digitální kopie
                                    dokumentu (MZK)</a>
                            </b>
                        </div>
                    </xsl:if>
...
{ 
    ...
    <xsl:template match="locus">
        ...
        <xsl:choose>
            <xsl:when test="//facsimile[@xml:base]">
                ...
                <xsl:variable name="url_target">
                    <xsl:apply-templates
                        select="//facsimile/surface[@xml:id = $target]"
                    />
                </xsl:variable>
                <xsl:variable name="url_from">
                    <xsl:apply-templates
                        select="//facsimile/surface[@xml:id = $from]"
                    />
                </xsl:variable>
                <xsl:variable name="url_to">
                    <xsl:apply-templates
                        select="//facsimile/surface[@xml:id =
                        $to]"
                    />
                </xsl:variable>
                <xsl:choose>
                    <xsl:when test="@target">
                        <xsl:element name="a">
                            ...
                            <xsl:attribute name="href">
                                <xsl:value-of select="concat($base_url, $url_target)"/>
                            </xsl:attribute>
                            <xsl:value-of select="."/>
                        </xsl:element>
                    </xsl:when>
                    <xsl:when test="@from and @to">
                        ...
                        <xsl:element name="a">
                            ...
                            <xsl:attribute name="href">
                                <xsl:value-of select="concat($base_url, $url_from)"/>
                            </xsl:attribute>
                        ...
                        <xsl:element name="a">
                            ...
                            <xsl:attribute name="href">
                                <xsl:value-of select="concat($base_url, $url_to)"/>
                            </xsl:attribute>
   ...
   <xsl:choose>
        <xsl:when test="graphic/@url[contains(., '.jpg')]">
            <xsl:value-of select="graphic/@url[contains(., 'xcell')]"/>
        </xsl:when>
        <xsl:when test="graphic/@url[contains(., 'ImageProperties.xml')]">
            <xsl:value-of
                select="concat(substring-before(graphic/@url, '/ImageProperties.xml'),
                '.jp2')"
            />
        </xsl:when>
        <xsl:when test="graphic/@url[contains(., 'EX/')]">
    ...
    <xsl:template match="note[not(node())]"/>
</xsl:stylesheet>
