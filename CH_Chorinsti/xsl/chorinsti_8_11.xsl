...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="msDesc">
        ...
        <xsl:if test="msContents/summary">
            ...
            <xsl:apply-templates
                select="document('CH-RKP-0000.010.tei.xml')//msDesc/msContents/summary"/>
        </xsl:if>
        ...
        <xsl:if test="document('CH-RKP-0000.009.tei.xml')//msDesc/msContents/msItem">
            <xsl:apply-templates
                select="document('CH-RKP-0000.009.tei.xml')//msDesc/msContents/msItem"/>
        </xsl:if>
        <xsl:apply-templates
            select="document('CH-RKP-0000.009.tei.xml')//msDesc/msContents"/>
        <fo:block font-family="TimesNewRoman" font-weight="bold" font-size="18pt" line-height="25pt"
            color="black" space-before="20pt">Sv. 3. </fo:block>
        <xsl:if test="document('CH-RKP-0000.010.tei.xml')//msDesc/msContents/msItem">
            <xsl:apply-templates
                select="document('CH-RKP-0000.010.tei.xml')//msDesc/msContents/msItem"/>
        </xsl:if>
        <xsl:apply-templates
            select="document('CH-RKP-0000.010.tei.xml')//msDesc/msContents"/>
        <fo:block font-family="TimesNewRoman" font-weight="bold" font-size="18pt" line-height="25pt"
            color="black" space-before="20pt">Sv. 4. </fo:block>
        <xsl:if test="document('CH-RKP-0000.011.tei.xml')//msDesc/msContents/msItem">
            <xsl:apply-templates
                select="document('CH-RKP-0000.011.tei.xml')//msDesc/msContents/msItem"/>
        </xsl:if>
        <xsl:apply-templates
            select="document('CH-RKP-0000.011.tei.xml')//msDesc/msContents"/>
    ...
    <xsl:template match="msIdentifier">
        ...
        <fo:block font-family="TimesNewRoman" font-size="14pt" line-height="25pt" color="black"
            ...
            <fo:inline>
                <xsl:value-of
                    select="document('CH-RKP-0000.008.tei.xml')//msDesc/head/origDate/@notBefore"/>
                <xsl:text>-</xsl:text>
                <xsl:value-of
                    select="document('CH-RKP-0000.011.tei.xml')//msDesc/head/origDate/@notAfter"/>
                <!--  <xsl:choose>
            ...
            <fo:leader leader-length="30pt" leader-pattern="space"/>
            <xsl:text>4 svazky</xsl:text>
            <fo:leader leader-length="30pt" leader-pattern="space"/>
            <fo:inline>
                <xsl:value-of select="//msDesc/physDesc/objectDesc/supportDesc/extent"/>
                <xsl:text>, </xsl:text>
                <xsl:value-of
                    select="document('CH-RKP-0000.009.tei.xml')//msDesc/physDesc/objectDesc/supportDesc/extent"/>
                <xsl:text>, </xsl:text>
                <xsl:value-of
                    select="document('CH-RKP-0000.010.tei.xml')//msDesc/physDesc/objectDesc/supportDesc/extent"/>
                <xsl:text>, </xsl:text>
                <xsl:value-of
                    select="document('CH-RKP-0000.011.tei.xml')//msDesc/physDesc/objectDesc/supportDesc/extent"
                />
            </fo:inline>
            <!--  <fo:leader leader-length="30pt" leader-pattern="space"/>
            <fo:inline>
